...
/**
 * Class WP_EXT_News_Post_Type
 */
class WP_EXT_News_Post_Type extends WP_EXT_News {
	...
	public function post_type() {
		$labels  = [
			'name'                  => _x( 'Новости', 'News General Name', 'wp-ext-' . $this->domain_ID ),
			'singular_name'         => _x( 'Новость', 'News Singular Name', 'wp-ext-' . $this->domain_ID ),
			'menu_name'             => __( 'Новости', 'wp-ext-' . $this->domain_ID ),
			'name_admin_bar'        => __( 'Новость', 'wp-ext-' . $this->domain_ID ),
		...
		$args    = [
			'label'               => __( 'Новости', 'wp-ext-' . $this->domain_ID ),
			'description'         => __( 'News Description', 'wp-ext-' . $this->domain_ID ),
			'labels'              => $labels,
 ...
 *
 * @return WP_EXT_News_Post_Type
 */
function WP_EXT_News_Post_Type() {
	static $object;

	if ( null == $object ) {
		$object = new WP_EXT_News_Post_Type;
	}
 ...
 */
add_action( 'plugins_loaded', [ WP_EXT_News_Post_Type(), 'run' ] );
