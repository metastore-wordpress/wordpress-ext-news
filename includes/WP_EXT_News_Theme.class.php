...
/**
 * Class WP_EXT_News_Theme
 */
class WP_EXT_News_Theme extends WP_EXT_News {
 ...
 *
 * @return WP_EXT_News_Theme
 */
function WP_EXT_News_Theme() {
	static $object;

	if ( null == $object ) {
		$object = new WP_EXT_News_Theme;
	}
 ...
 */
add_action( 'plugins_loaded', [ WP_EXT_News_Theme(), 'run' ] );
