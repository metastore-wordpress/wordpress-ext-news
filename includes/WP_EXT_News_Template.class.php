...
/**
 * Class WP_EXT_News_Template
 */
class WP_EXT_News_Template extends WP_EXT_News {
 ...
 *
 * @return WP_EXT_News_Template
 */
function WP_EXT_News_Template() {
	static $object;

	if ( null == $object ) {
		$object = new WP_EXT_News_Template;
	}
 ...
 */
add_action( 'plugins_loaded', [ WP_EXT_News_Template(), 'run' ] );
